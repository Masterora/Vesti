...
export const messages = {
  en: {
    ...
    contractDetail: {
      ...
      claimedNotice: "Workers have claimed this project. Creator review is required before funding.",
      ...
      applicantPendingNotice: "Your claim is in the review queue. Wait for the Creator to select a Worker.",
  ...
  zh: {
    ...
    contractList: {
      ...
      unassigned: "待认领",
      pendingClaim: "待确认认领",
      creatorClaimHint: "打开项目详情，查看认领列表并选择乙方后，再继续注资。",
    ...
    contractDetail: {
      ...
      claimedNotice: "已有多位乙方认领该项目，等待甲方确认后再注资。",
      ...
      acceptClaim: "确认认领",
      acceptingClaim: "确认中...",
      applicantPendingNotice: "你的认领请求正在等待甲方处理。",
      cancelDraft: "取消项目",
      cancelling: "取消中...",
      milestones: "里程碑",
      milestoneItem: "里程碑",
